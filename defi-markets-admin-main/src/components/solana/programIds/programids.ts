...
export const VAULT_FACTORY_PROGRAM_ID = new PublicKey(
    import.meta.env.VITE_VAULT_FACTORY_PROGRAM_ID || '2LcW6FE3mhzpu43creSzyw1y43km7B8x8iZVrCx1CQVZ'
  );

export const ETF_VAULT_PROGRAM_ID = new PublicKey(
    import.meta.env.VITE_ETF_VAULT_PROGRAM_ID || '11111111111111111111111111111111'
  );
