  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        mono: ["var(--font-mono)", "Space Mono", "Microgramma", "monospace"],
        architekt: ["Space Mono", "Inter", "system-ui", "sans-serif"],
        microgram: ["Space Mono", "Microgramma", "monospace"],
        microgramma: ["Space Mono", "Microgramma", "monospace"],
      },
      colors: {
